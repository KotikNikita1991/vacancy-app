...
// ── Компетенции для расширенной оценки кандидата ─────────────────────
const CL_COMPETENCIES=[
  {id:'C1',group:'C',groupLabel:'Базовые компетенции',label:'Ориентация на результат',hint:'Конкретные метрики достижения, преодоление препятствий, своя роль vs «мы»'},
  {id:'C2',group:'C',groupLabel:'Базовые компетенции',label:'Ответственность',hint:'Внутренний локус контроля, берёт ответственность за ошибки, системная профилактика повторения'},
  {id:'C3',group:'C',groupLabel:'Базовые компетенции',label:'Системность мышления',hint:'Причинно-следственные связи, влияние на смежные функции, измеримый результат до/после'},
  {id:'C4',group:'C',groupLabel:'Базовые компетенции',label:'Деловая коммуникация',hint:'Структурированность речи, понимание аудитории, аргументация, реакция на возражения'},
  {id:'C5',group:'C',groupLabel:'Базовые компетенции',label:'Развитие и обучаемость',hint:'Конкретное обучение за год, применение знаний в практике, спокойная реакция на критику'},
  {id:'C6',group:'C',groupLabel:'Базовые компетенции',label:'Этика и лояльность',hint:'Отказ от неэтичного без колебаний, эскалация нарушений, честность с руководством'},
  {id:'M1',group:'M',groupLabel:'Управленческие',label:'Постановка целей и делегирование',hint:'SMART-задача, передача контекста, критерии готовности, точки контроля'},
  {id:'M2',group:'M',groupLabel:'Управленческие',label:'Контроль и обратная связь',hint:'Регулярные 1-1, структурированная ОС (факт→последствие→ожидание), фиксация договорённостей'},
  {id:'M3',group:'M',groupLabel:'Управленческие',label:'Решения в неопределённости',hint:'Действует при неполной информации, анализирует альтернативы, несёт ответственность за выбор'},
  {id:'M4',group:'M',groupLabel:'Управленческие',label:'Управление командой',hint:'Развивает людей (ИПР, проекты, ОС), принимает сложные кадровые решения этично'},
  {id:'M5',group:'M',groupLabel:'Управленческие',label:'Стратегическое планирование',hint:'Горизонт планирования, связка стратегии и тактики, план-факт анализ, корректировки'},
  {id:'M6',group:'M',groupLabel:'Управленческие',label:'Конфликты и переговоры',hint:'Поиск интересов сторон а не позиций, удержание рамок при давлении, win-win решения'},
];

const CL_SCORE_LABELS=['','Не выявлено','Ниже ожиданий','Соответствует','Выше ожиданий','Превосходит'];
const CL_SCORE_COLORS=['','#ef4444','#f59e0b','#3b82f6','#10b981','#7b5ea7'];

const CL_RECS=[
  {id:'strong_hire',label:'Однозначно нанять',badge:'Strong Hire',color:'#059669',bg:'#d1fae5',icon:'⭐'},
  {id:'hire',label:'Нанять',badge:'Hire',color:'#2563eb',bg:'#dbeafe',icon:'✅'},
  {id:'hire_caveats',label:'Нанять с оговорками',badge:'Hire with caveats',color:'#d97706',bg:'#fef3c7',icon:'⚠️'},
  {id:'no_hire',label:'Не нанимать',badge:'No Hire',color:'#dc2626',bg:'#fee2e2',icon:'❌'},
  {id:'strong_no',label:'Категорически отказать',badge:'Strong No',color:'#7f1d1d',bg:'#fca5a5',icon:'🚫'},
];
