...
const NCFG={
  recruiter:[{id:'dashboard',lbl:'Дашборд',ic:'home'},{id:'analytics',lbl:'Аналитика',ic:'ch'},{id:'checklist',lbl:'Оценка кандидата',ic:'cl'},{id:'values',lbl:'Оценка ценностей',ic:'val'}],
  manager:  [{id:'dashboard',lbl:'Дашборд',ic:'home'},{id:'analytics',lbl:'Аналитика',ic:'ch'},{id:'checklist',lbl:'Оценка кандидата',ic:'cl'},{id:'values',lbl:'Оценка ценностей',ic:'val'}],
  admin:    [{id:'dashboard',lbl:'Дашборд',ic:'home'},{id:'analytics',lbl:'Аналитика',ic:'ch'},{id:'checklist',lbl:'Оценка кандидата',ic:'cl'},{id:'values',lbl:'Оценка ценностей',ic:'val'},{id:'users',lbl:'Пользователи',ic:'us'}],
};
const IC={
